...
export class ActionDialog extends Dialog {
    ...
    constructor(combatants, options = { action : true, bonus : true, reaction : true, legendary : true, lair : true, special : true, id: ActionDialog.DEFAULT_ID }){
        ...
        */
        ...
        this.data.buttons = { 
            close: { label: HELPER.format("Close"), callback: ActionDialog.storePosition}
        };
    ...
    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            template : `modules/simbuls-athenaeum/templates/ActionDialog.html`,
            classes: ["simbuls-athenaeum","action-dialog"], 
            resizable: false,
